...
import TopImage from './assets/faq.png'
  ...
  <div className="container-fluid p-x-0">
    ...
    <div className={"row " + classes['img-at-top-background']}>
      ...
      <div className="col-md-10">
        <p className={classes['text-header']}>FREQUENTLY ASKED QUESTIONS</p>
      </div>
      <div className="col-md-1"/>
    </div>
    <div className="row">
    ...
    <div className="row">
      ...
      <div className="col-md-3  text-xs-center">
        <p className={classes['text-icon']}>Visitors</p>
      </div>
      <div className="col-md-4  text-xs-center">
        <p className={classes['text-icon']}>Members</p>
      </div>
      <div className="col-md-3  text-xs-center">
        <p className={classes['text-icon']}>Schools</p>
      </div>
      <div className="col-md-1"/>
    </div>
    <div className="row">
