...
import classes from './CompletedReview.scss'

export const AddReview = (props) => (
  <div id="pt-main" className="container-fluid p-x-0 ">
  <div className={"row " + classes['os-background-top']}>
    ...
    <div className="col-md-10 text-xs-center">
      ...
      <p className={classes['subtitle']}>
        We have received your review. It will be published after our editors approval, which
        will take a few hours to X working days at most.
      </p>
      <p className={classes['normal']}>
        View <a className={classes['text-link']} href="#">My Review</a> | Back to <a className={classes['text-link']} href="/homeView">Home</a>
      </p>
    </div>
    <div className="col-md-1"></div>
  </div>
